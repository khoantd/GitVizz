...
const GraphControls = ({ 
  ...
  const buttonHoverColor = theme === 'dark' ? 'hover:bg-gray-700' : 'hover:bg-gray-100';
  ...
  return (
    <div 
      className={`fixed bottom-4 left-4 ${bgColor} ${textColor} rounded-lg border ${borderColor} shadow-lg z-10 backdrop-blur-sm transition-all duration-300 ${showControls ? 'opacity-100' : 'opacity-30'}`}
